...
/*
 Для главной страницы index.html. В разделе Header считываем id элементов
 тега <a> на мультикалькуляторы,
...
/*
 Для главной страницы index.html. В разделе SectionTwo считываем id элементов
 тега <a> на мультикалькуляторы,
 и присваиваем им ссылки, чтобы они были кликабельны.
 Присваиваем для удобства(оптимизации) их замены, в случае изменения их адреса,
 чтобы не искать их в огромном файле index.html.
*/
document.getElementById('sectionTwo__borsch').href = 'http://192.168.1.101:5500/6_1_borschPage/borschIndex.html';
document.getElementById('sectionTwo__pancake').href = 'http://192.168.1.101:5500/6_2_pancakesPage/pancakesPageIndex.html';
document.getElementById('sectionTwo__pilaf').href = 'http://192.168.1.101:5500/6_3_pilafPage/pilafIndex.html';
document.getElementById('sectionTwo__mortgage').href = 'http://192.168.1.101:5500/6_4_mortgageCalculatorPage/mortgageCalculatorIndex.html';
document.getElementById('sectionTwo__day').href = 'http://192.168.1.101:5500/6_5_dailyCalculatorPage/dailyCalculatorIndex.html';
document.getElementById('sectionTwo__factsCats').href = 'http://192.168.1.101:5500/6_6_factsAboutCatsPage/factsAboutCatsIndex.html';
document.getElementById('sectionTwo__energy').href = 'http://192.168.1.101:5500/6_7_electricityCalculatorPage/electricityCalculatorIndex.html';
document.getElementById('sectionTwo__coldWater').href = 'http://192.168.1.101:5500/6_8_waterCalculatorPage/waterCalculatorIndex.html';
document.getElementById('sectionTwo__todoList').href = 'http://192.168.1.101:5500/6_9_dailyTodoListPage/dailyTodoListIndex.html';
document.getElementById('sectionTwo__password').href = 'http://192.168.1.101:5500/6_10_passwordGeneratorPage/passwordGeneratorIndex.html';
document.getElementById('sectionTwo__notepad').href = 'http://192.168.1.101:5500/6_11_notepadPage/notepadIndex.htm';
document.getElementById('sectionTwo__informationIp').href = 'http://192.168.1.101:5500/6_12_informationIpPage/informationIpIndex.html';
